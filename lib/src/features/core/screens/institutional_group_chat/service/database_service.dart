...
import 'package:integritylink/src/features/core/screens/institutional_group_chat/pages/chat_page.dart';
...
class DatabaseService {
  ...
  Future<void> createSchool(InstModel school) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      print("Main group already exists");
    } else {
      ...
      await groupDocumentReference.update({
        ...
        "schools": FieldValue.arrayUnion(["${school.name}"]),
  ...
  Future toggleGroupJoin(
    ...
    if (groups.contains("${groupId}_$groupName")) {
      ...
      await userDocumentReference.update({
        "instGroups": FieldValue.arrayUnion(["${groupId}_$groupName"])
      });
      await groupDocumentReference.update({
        "members": FieldValue.arrayUnion(["${uid}_$userName"])
      }).then((value) => (value) {
